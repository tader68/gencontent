        ...
        for ctype in content_types:
            ...
            if ctype == 'Poem':
                ...
                prompt = (
                    ...
                    "YÊU CẦU:\n"
                    "1. Ngôn ngữ trẻ trung, có vần điệu tốt, flow cuốn hút, có điểm nhấn (punchline) ấn tượng.\n"
                ...
                prompt = (
                    ...
                    "4. ƯU TIÊN: Sáng tạo, dễ thương, bất ngờ, dùng hình ảnh liên tưởng, ẩn dụ, cảm xúc mạnh, phong cách riêng biệt, ý nghĩa. Hãy tưởng tượng như một người viết lời chúc chuyên nghiệp tạo ra mỗi lời chúc là một màu sắc riêng.\n"
